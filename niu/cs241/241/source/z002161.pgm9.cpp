/***********************************************************************
	...
	Output:		a file called z002161.pgm9.out
...
struct prof_reference
{
	...
	int points ;				// accumulate points earned by all students in the teacher's class.
	int credit ;				// same as above only applies to class credit.
	double teacher_gpa;		// teacher gpa calculated based on student's grades
	int students;				// number of students taking a class from this teacher.
};
...
struct student
{
	...
	int credit;					// accumulative credit earned by student from previous year.
	int newCredit;				// accumulative credit earned by student from last year and this year.
	...
	char status2[10];			// status of student after new grades are included.
};
...
Arguments:	ofstream, student[], counter, status.
Returns:		none
Notes:		NA
**************************************************************************/
...
Arguments:	prof_reference [], int, int, ofstream.
Returns:		none
Notes:		NA
**************************************************************************/
