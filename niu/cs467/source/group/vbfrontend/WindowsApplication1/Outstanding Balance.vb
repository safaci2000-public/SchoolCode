...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Outstanding_Balance))
        ...
        Me.Adapter1.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "CUSTOMER", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("CUSTOMER-FIRST-NAME", "CUSTOMER-FIRST-NAME"), New System.Data.Common.DataColumnMapping("CUSTOMER-LAST-NAME", "CUSTOMER-LAST-NAME"), New System.Data.Common.DataColumnMapping("CUSTOMER-NEW-BALANCE-OWED", "CUSTOMER-NEW-BALANCE-OWED")})})
        Me.Adapter1.UpdateCommand = Me.OleDbUpdateCommand1
        '
        'OleDbDeleteCommand1
        '
        Me.OleDbDeleteCommand1.CommandText = "DELETE FROM CUSTOMER WHERE ([CUSTOMER-NUMBER] = ?) AND ([CUSTOMER-FIRST-NAME] = ?" & _
        " OR ? IS NULL AND [CUSTOMER-FIRST-NAME] IS NULL) AND ([CUSTOMER-LAST-NAME] = ? O" & _
        "R ? IS NULL AND [CUSTOMER-LAST-NAME] IS NULL) AND ([CUSTOMER-NEW-BALANCE-OWED] =" & _
        " ? OR ? IS NULL AND [CUSTOMER-NEW-BALANCE-OWED] IS NULL)"
        ...
        'OleDbInsertCommand1
        '
        Me.OleDbInsertCommand1.CommandText = "INSERT INTO CUSTOMER([CUSTOMER-FIRST-NAME], [CUSTOMER-LAST-NAME], [CUSTOMER-NEW-B" & _
        "ALANCE-OWED], [CUSTOMER-NUMBER]) VALUES (?, ?, ?, ?)"
        ...
        'OleDbSelectCommand1
        '
        Me.OleDbSelectCommand1.CommandText = "SELECT [CUSTOMER-NUMBER] AS Expr1, CUSTOMER.* FROM CUSTOMER ORDER BY [CUSTOMER-NE" & _
        "W-BALANCE-OWED] DESC"
        Me.OleDbSelectCommand1.Connection = Me.Connect
        '
        'OleDbUpdateCommand1
        '
        Me.OleDbUpdateCommand1.CommandText = "UPDATE CUSTOMER SET [CUSTOMER-FIRST-NAME] = ?, [CUSTOMER-LAST-NAME] = ?, [CUSTOME" & _
        "R-NEW-BALANCE-OWED] = ?, [CUSTOMER-NUMBER] = ? WHERE ([CUSTOMER-NUMBER] = ?) AND" & _
        " ([CUSTOMER-FIRST-NAME] = ? OR ? IS NULL AND [CUSTOMER-FIRST-NAME] IS NULL) AND " & _
        "([CUSTOMER-LAST-NAME] = ? OR ? IS NULL AND [CUSTOMER-LAST-NAME] IS NULL) AND ([C" & _
        "USTOMER-NEW-BALANCE-OWED] = ? OR ? IS NULL AND [CUSTOMER-NEW-BALANCE-OWED] IS NU" & _
        "LL)"
        ...
        Me.Grid1.CaptionText = "        Last Name First Name Balance"
        ...
        Me.Grid1.Location = New System.Drawing.Point(88, 80)
        Me.Grid1.Name = "Grid1"
        ...
        Me.Grid1.Size = New System.Drawing.Size(320, 264)
        Me.Grid1.TabIndex = 1
        '
        'Label1
        '
        ...
        'cmd1
        '
        Me.cmd1.Connection = Me.Connect
        '
        'Label2
        '
        Me.Label2.BackColor = System.Drawing.Color.Transparent
        Me.Label2.Font = New System.Drawing.Font("Monotype Corsiva", 14.25!, (System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic), System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.Label2.ForeColor = System.Drawing.SystemColors.Highlight
        Me.Label2.Location = New System.Drawing.Point(152, 360)
        Me.Label2.Name = "Label2"
        Me.Label2.Size = New System.Drawing.Size(160, 23)
        Me.Label2.TabIndex = 3
        Me.Label2.Text = "Outstanding Totals:"
        '
        'totall
        '
        Me.totall.BackColor = System.Drawing.Color.Transparent
        Me.totall.Font = New System.Drawing.Font("Monotype Corsiva", 12.0!, (System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic), System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.totall.ForeColor = System.Drawing.SystemColors.Highlight
        Me.totall.Location = New System.Drawing.Point(312, 360)
        ...
        Me.Label3.Text = "Oustanding Balance Report"
        '
        'Outstanding_Balance
        '
        ...
        Me.ControlBox = False
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.Label3, Me.totall, Me.Label2, Me.Label1, Me.Grid1})
        Me.Menu = Me.MainMenu1
        Me.Name = "Outstanding_Balance"
        Me.Text = "Outstanding Balance Report"
...
#End Region
    ...
    Private Sub Outstanding_Balance_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Label1.Text = "Today's Date:  " + Today
        Try
            Adapter1.SelectCommand.CommandText = _
              "SELECT [CUSTOMER-FIRST-NAME], [CUSTOMER-LAST-NAME], " & _
              "[CUSTOMER-NEW-BALANCE-OWED] FROM CUSTOMER WHERE " & _
              "[CUSTOMER-NEW-BALANCE-OWED] > 0 " & _
              "ORDER BY [CUSTOMER-NEW-BALANCE-OWED] DESC"
        ...
        sql1 = "SELECT SUM([CUSTOMER-NEW-BALANCE-OWED]) FROM CUSTOMER"
        ...
        Try
            ...
            total = CType(cmd1.ExecuteScalar(), Double)

        Catch oleDbExceptionParameter As System.Data.OleDb.OleDbException
            MessageBox.Show("Invalid Query")
        End Try
        totall.Text = "$" + CType(total, String)
    End Sub
